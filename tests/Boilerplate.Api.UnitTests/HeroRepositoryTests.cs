...
namespace Boilerplate.Api.UnitTests
{
    public class HeroRepositoryTests
    {
        ...
        public async Task GetById_existing_heroes(Guid id)
        {
            ...
            {
                context.Set<Hero>().Add(new Hero(id));
        ...
        public async Task GetAll_heroes(int count)
        {
            ...
            {
                for (var i = 0; i < count; i++) context.Set<Hero>().Add(new Hero(new Guid()));
                await context.SaveChangesAsync();
            }
        ...
        public async Task Update_Hero()
        {
            ...
            {
                var createdHero = new Hero(new Guid())
                {
                    Age = 10,
                    Name = "Izuku Midoriya",
                    Nickname = "Deku",
                ...
                context.Set<Hero>().Add(new Hero(new Guid()) { Name = "Another Hero", HeroType = HeroType.Vigilante, Age = 17 });
                await context.SaveChangesAsync();
